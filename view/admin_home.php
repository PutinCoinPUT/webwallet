<div class="container">
   <div class="row">
      <div class="col-sm-12 text-center" style='margin-top: 25px;'>
         ...
         <?php
         if (!empty($error)) {
            echo "<p style='font-weight: bold; color: red;'>" . $error['message'];
            "</p>";
         }
         if (!empty($msg)) {
            echo "<p style='font-weight: bold; color: green;'>" . $msg['message'];
            "</p>";
         }
         ?>
         <a href="?" class="btn btn-default">Go back to wallet</a>
         <p>List of all users:</p>
         <table class="table table-bordered table-striped tab" id="userlist">
            <thead>
               <tr>
